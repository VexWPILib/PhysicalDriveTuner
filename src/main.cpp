...
void testForward() {
  ...
  DifferentialDriveChassis m_chassis(mg_left, mg_right, vpi::ui::wheelTrack, vpi::ui::wheelDiameter, ROBOT_GEAR_SETTING, ROBOT_GEAR_RATIO, vex::brakeType::coast);
...
int main() {
  ...
  /*
  vex::inertial inertialSensor(PORT5);
